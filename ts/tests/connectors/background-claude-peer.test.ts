...
it.each([false,true])("emitted JS worker runs with no sibling sources or loader hooks (peer=%s)", async enabled => {
  ...
  for (const name of ["connectors/background","connectors/claude-bg-worker","connectors/peer-worker-lifecycle","connectors/peer-sidecar","connectors/peer-registry","connectors/base","connectors/proc_identity","connectors/claude","connectors/codex","connectors/cancellation","config/index","config/types","judge/pricing"]) {
